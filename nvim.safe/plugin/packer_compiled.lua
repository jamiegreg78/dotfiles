...
_G.packer_plugins = {
  ...
  ["git.nvim"] = {
    loaded = true,
    path = "/Users/jamie/.local/share/nvim/site/pack/packer/start/git.nvim",
  ...
  ["lspkind-nvim"] = {
    loaded = true,
    path = "/Users/jamie/.local/share/nvim/site/pack/packer/start/lspkind-nvim",
  ...
  ["nvim-ts-autotag"] = {
    loaded = true,
    path = "/Users/jamie/.local/share/nvim/site/pack/packer/start/nvim-ts-autotag",
  ...
  ["oxocarbon.nvim"] = {
    loaded = true,
    path = "/Users/jamie/.local/share/nvim/site/pack/packer/start/oxocarbon.nvim",
  ...
  ["telescope-file-browser.nvim"] = {
    loaded = true,
    path = "/Users/jamie/.local/share/nvim/site/pack/packer/start/telescope-file-browser.nvim",
